...
namespace ribi {
  namespace testconceptmapdialog {
...
ribi::cmap::QtTestConceptMapDialog::QtTestConceptMapDialog(QWidget *parent) :
  QtPage(parent),
  ui(new Ui::QtTestConceptMapDialog),
...
ribi::cmap::QtTestConceptMapDialog::~QtTestConceptMapDialog() noexcept
{
  delete ui;
}
...
void ribi::cmap::QtTestConceptMapDialog::OnCheck()
{
...
void ribi::cmap::QtTestConceptMapDialog::OnVirtualBastard()
{
  static int n_keys = 0;
  //TRACE(n_keys);
  ++n_keys;
  ...
  QKeyEvent event{
    testconceptmapdialog::CreateRandomKey()
  };
...
void ribi::cmap::QtTestConceptMapDialog::on_button_view_graphviz_summary_clicked()
{
...
void ribi::cmap::QtTestConceptMapDialog::on_button_view_graphviz_full_clicked()
{
  SaveToFile(m_qtconceptmap->GetConceptMap(),"full.dot");
  convert_dot_to_svg("full.dot","full.svg");
  convert_svg_to_png("full.svg","full.png");
...
void ribi::cmap::QtTestConceptMapDialog::on_box_run_virtual_bastard_stateChanged(int /* arg1 */)
{
  ToggleVirtualBastard();
}

void ribi::cmap::QtTestConceptMapDialog::on_box_mode_currentIndexChanged(int index)
{
  switch(index)
  {
...
void ribi::cmap::QtTestConceptMapDialog::on_button_set_concept_map_clicked()
{
  static int i = 0;
